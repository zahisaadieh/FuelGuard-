...
function AddManagerForm({ onSuccess }) {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:3000/api/managers/add', {
                email,
                password,
                firstName,
                lastName,
            ...
            Swal.fire({
                icon: 'success',
                title: 'Manager Added',
                text: response.data.message || 'The manager was added successfully.',
            });
                    ...
                    <div className="relative p-4 w-full max-w-md">
                        <div className="bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="flex items-center justify-between p-4 border-b dark:border-gray-600">
                                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Add a Manager</h3>
                                <button
                                    onClick={closeModal}
