    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            Swal.fire({
                ...
                text: response.data.message || 'The customer was added successfully.',
            });
                    ...
                    <div className="relative p-4 w-full max-w-md">
                        <div className="bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="flex items-center justify-between p-4 border-b dark:border-gray-600">
                                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Add a Customer</h3>
                                <button
                                    onClick={closeModal}
                            ...
                            <div className="p-4">
                                <form className="space-y-4" onSubmit={handleSubmit}>
                                    ...
                                    <div>
                                        <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Credit Limit</label>
                                        <input
                                            type="number"
                                            value={creditLimit}
